...
const List<LevelTheme> kLevelThemes = [
  // 1. Latte Lounge — warm wood walls, cream tile floor
  LevelTheme('Latte Lounge', Icons.coffee_rounded, Color(0xFFE8A87C), 'assets/images/categories/latte_lounge.jpg',
      TilePalette(
  ...
  // 2. Catnip Corner — warm terracotta walls, soft sage floor
  LevelTheme('Catnip Corner', Icons.pets_rounded, Color(0xFFF6C667), 'assets/images/categories/catnip_corner.jpg',
      TilePalette(
        wallLight: Color(0xFF9E7E5A), wallBase: Color(0xFF7A5C38), wallDark: Color(0xFF5A3E20), wallSeam: Color(0xFF3E2810),
        floorLight: Color(0xFFE8EFDA), floorBase: Color(0xFFD5DFC4), floorDark: Color(0xFFBCC8A8),
        grain: Color(0xFF8A9A6C), decor: Color(0xFFE6A040),
      )),
  // 3. Velvet Nook — dark mahogany walls, parquet floor
  LevelTheme('Velvet Nook', Icons.weekend_rounded, Color(0xFFB08968), 'assets/images/categories/velvet_nook.jpg',
      TilePalette(
  ...
  LevelTheme('Bakery Corner', Icons.bakery_dining_rounded, Color(0xFFD9886C), 'assets/images/categories/bakery_corner.jpg',
      TilePalette(
  ...
  LevelTheme('Tea Room', Icons.emoji_food_beverage_rounded, Color(0xFFC9A0DC), 'assets/images/categories/tea_room.jpg',
      TilePalette(
  ...
  LevelTheme('Greenhouse', Icons.eco_rounded, Color(0xFF8BBE7A), 'assets/images/categories/greenhouse.jpg',
      TilePalette(
  ...
  LevelTheme('Toy Shop', Icons.toys_rounded, Color(0xFFEC7B9F), 'assets/images/categories/toy_shop.jpg',
      TilePalette(
  ...
  LevelTheme('Reading Loft', Icons.chair_rounded, Color(0xFF9BB8CD), 'assets/images/categories/reading_loft.jpg',
      TilePalette(
  ...
  // 9. Sunny Garden — sea-blue tile walls, wet stone floor
  LevelTheme('Sunny Garden', Icons.local_florist_rounded, Color(0xFF6FB6C8), 'assets/images/categories/sunny_garden.jpg',
      TilePalette(
  ...
  // 10. Whisker Terrace — sunset brick walls, warm tile floor
  LevelTheme('Whisker Terrace', Icons.deck_rounded, Color(0xFFCC6F70), 'assets/images/categories/whisker_terrace.jpg',
      TilePalette(
